...
public class Loan_Clousure_EMI_Type extends BaseLoginForAllBranchModules
{
	WebDriverWait wait;
	
	@Test(priority = 1)
	public void Loan_Clousure_EMI_Type_Navigation() throws Exception
	{
	...
	@Test(priority = 2)
	public void Loan_Clousure_EMI_Type_Actions()
	{
		wait=new WebDriverWait(driver, Duration.ofSeconds(30));
