...
import PropertiesCodeForBranch.AdminCode;

//Change 
//Form 13 -> Change Applicant Type in every Run

public class Pending_Loan_For_Approval extends BaseLoginForAllBranchModules
{
	WebDriverWait wait;
	
	@Test(priority = 1, alwaysRun = true)
	public void Pending_Loan_For_Approval_Navigation() throws Exception
	{
...
//		{
//			if(statusOptions.get(i).getText().equalsIgnoreCase(LS))
//			{
...
//		Thread.sleep(2000);
		...
		//Next
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html[1]/body[1]/main[1]/div[2]/div[1]/form[1]/div[2]/div[1]/div[6]/button[1]"))).click();
		Thread.sleep(2000);
	}
	...
	public void Co_Application() throws Exception
	{
		...
		WebElement coApplicantType = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("dropdown")));
	...
	public void uploadDocument() throws Exception
	{
		...
		//Photo
		WebElement uploadPhoto1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("fileInput1")));
		String photo1 = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		uploadPhoto1.sendKeys(photo1);
		Thread.sleep(2000);
		
		//Customer
		WebElement customer = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("fileInput2")));
		String customerSign = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		customer.sendKeys(customerSign);
		Thread.sleep(2000);
		
		//Aadhar Card
		WebElement AdharCard = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("fileInput3")));
		String AdharCardKYC = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		AdharCard.sendKeys(AdharCardKYC);
		Thread.sleep(2000);
		
		//Pan Card
		WebElement PanCard = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("fileInput4")));
		String PanCardKYC = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		PanCard.sendKeys(PanCardKYC);
		Thread.sleep(2000);
		
		//PassPort
		WebElement Passport = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("fileInput5")));
		String passportKYC = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		Passport.sendKeys(passportKYC);
		Thread.sleep(2000);
		
		//shop registration
		WebElement shopRegistration = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("fileInput6")));
		...
		//GST
		WebElement GST = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("fileInput7")));
		String GSTBusinessKYC = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		GST.sendKeys(GSTBusinessKYC);
		Thread.sleep(2000);
		
		//ITR
		WebElement ITR = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("fileInput8")));
	...
	{	
		...
		//TypeOFAC
		WebElement TypeOfAccount = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pdc_acc_type")));
		...
		//Type A/C
		WebElement TypeOfAccount1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='nach_acc_type']")));
	...
	public void Bank_Account() throws Exception
	{
		...
		//TypeOfAccount
		WebElement TypeOfAccount1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='acc_type']")));
		Select selectAccount1 = new Select(TypeOfAccount1);
		List<WebElement> accountOptions1 = selectAccount1.getOptions();
	...
	public void CreditCardDetails() throws Exception
	{
		...
		//TypeOfCard
		WebElement typeOfCard= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='card_type']")));
	...
	{	
		...
		//Name1
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@placeholder='Enter Name 1']"))).clear();
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@placeholder='Enter Name 1']"))).sendKeys("Auto QA Tester");
		Thread.sleep(2000);
		...
		//state
		WebElement State= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='state1']")));
		...
		//state
		WebElement State1= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='state2']")));
	...
	public void collateralDetails() throws Exception
	{
		...
		//CategoryType
		WebElement Categories= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='category_type']")));
		...
		//UploadDocument
		WebElement uploadDOC = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='document']")));
	...
	{	
		...
		//UploadDocument
		WebElement uploadDOC1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='document_file']")));
...
//		Thread.sleep(2000);
	...
	public void AddressVerification() throws Exception
	{
		...
		//ScrollDown
		WebElement scrollDown5 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[normalize-space()='Confirm']")));
		...
		//KYCDocumnetUpload
		//Aadhar Card 
		WebElement uploadAdhar = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='aadhaar_card']")));
		String DOCPathA = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		uploadAdhar.sendKeys(DOCPathA);
		Thread.sleep(2000);
		
		//Pan Card 
		WebElement uploadPAN = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='pan_card']")));
		String DOCPathP = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		uploadPAN.sendKeys(DOCPathP);
		Thread.sleep(2000);
		
		//Passport 
		WebElement uploadPassport = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='passport']")));
		...
		//Applicant Type
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("applicant_type"))).click();
		System.out.println("----------Form 13 -> Select Applicant Type Manually----------");
		Thread.sleep(10000);
...
//		Thread.sleep(2000);
		...
		//Verification Status
		WebElement verificationStatus = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='verification_status']")));
	...
	public void DocumentVerification() throws Exception
	{
		...
		//ImageUpload
		WebElement ImageUpload = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='fileInput2']")));
		String imagePath = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		ImageUpload.sendKeys(imagePath);
		Thread.sleep(2000);
		
		//Sign Upload
		WebElement SignUpload = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='fileInput3']")));
		String signPath = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		SignUpload.sendKeys(signPath);
		Thread.sleep(2000);
		
		//Business Proof Document
		WebElement BusinessProof = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='fileInput4']")));
		String businessPath = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		BusinessProof.sendKeys(businessPath);
		Thread.sleep(2000);
		
		//Business KYC
		WebElement businessKYC = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='fileInput5']")));
		String KYCPath = "C:\\Users\\Shree\\Desktop\\photos use in auotmation\\1.PNG";
		businessKYC.sendKeys(KYCPath);
		Thread.sleep(2000);
		
		//FinancialITR
		WebElement FinancialITR = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='fileInput6']")));
...
//		Thread.sleep(2000);
	...
	public void addProductDetails() throws Exception
	{
		...
		//SelectVendor
		WebElement vendor = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='vendor']")));
		...
		//SelectCategory
		WebElement Categories1= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='category_name']")));
		...
		//ProductCategory
		WebElement Categories2= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//select[@name='product_category']")));
	...
	public void NavigateToAdmin() throws Exception
	{
		...
		//Navigation
		Thread.sleep(2000);
		driver.navigate().to("https://demo.techplex.in/login");
		
//		String adminID = "demoadmin@gmail.com";
//		String adminPass = "Pawan@123";
//		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@placeholder='Email Address']"))).sendKeys(adminID);
//		Thread.sleep(2000);
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("passwordField"))).sendKeys(adminPass);
//		Thread.sleep(2000);
//		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id='submitBtn']"))).click();
//		Thread.sleep(2000);
		...
		AdminCode adminlogin = new AdminCode(driver);
	...
	public void ApprovePendingLoan() throws Exception
	{
		...
		//Need to add search through
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html[1]/body[1]/main[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/table[1]/tbody[1]/tr[1]/td[11]/button[1]"))).click();
		Thread.sleep(2000);
		
		//Approve Pending Loan 
		driver.navigate().to("https://demo.techplex.in/admin-loan/add-product-details/17");
		Thread.sleep(5000);
		
		//Approve
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[@id='approveloan']"))).click();
		Thread.sleep(2000);
