...
public class Pigmy_Withdraw_Ledger extends BaseLoginForAllBranchModules
{
	WebDriverWait wait;
	
	@Test(priority = 1)
	public void pigmyWithdrawLedger() throws Exception
	{
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		
		//Direct navigation
		driver.navigate().to("https://demo.techplex.in/baccounts/ledger_pigmy_withdraw");
		Thread.sleep(2000);
