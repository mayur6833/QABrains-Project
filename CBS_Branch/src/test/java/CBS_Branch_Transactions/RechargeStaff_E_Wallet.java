...
public class RechargeStaff_E_Wallet extends BaseLoginForAllBranchModules
{
	WebDriverWait wait;
	...
	public void rechargeStaffEWallet() throws Exception
	{
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("agent_no"))).sendKeys(voucherNo);
		Thread.sleep(2000);
	    ...
	    WebElement copyVoucherNo = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html[1]/body[1]/div[3]/div[1]/div[2]/p[2]")));
...
//	    System.out.println(voucherNo);
	...
	public void checkWallet() throws Exception
	{
		...
		//Enter Agent No
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("agent_no"))).sendKeys(AgentNo);
		Thread.sleep(2000);
